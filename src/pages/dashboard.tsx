...
import { ShoppingCart, Banknote, Clock, Users, XCircle, CheckCircle, Package, Truck } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border-green-200 bg-green-50">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-700">{(stats as any).deliveredOrders ?? 0}</div>
            <p className="text-xs text-muted-foreground mt-1">Data sent successfully</p>
          </CardContent>
        </Card>

        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Paid (Awaiting)</CardTitle>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Awaiting M-Pesa</p>
          </CardContent>
        </Card>
